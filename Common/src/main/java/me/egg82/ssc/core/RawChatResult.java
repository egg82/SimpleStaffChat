...
public class RawChatResult {
    ...
    public RawChatResult(long id, long longServerID, long longPlayerID, byte level, String message, long date) {
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RawChatResult)) return false;
        RawChatResult that = (RawChatResult) o;
        return id == that.id;
    }
